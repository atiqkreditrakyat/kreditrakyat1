...
interface BenefitsProps {
    ...
    description?: string;
    items?: Array<{ icon: string; title: string; desc: string; gradient: string; shadow: string; blur: string; iColor?: string }>;
}

export default function Benefits({
    badge = "Keunggulan Kami",
    title = "Kelebihan Memohon",
    highlightedTitle = "Dengan Kami",
    description = "Nikmati pelbagai kelebihan eksklusif apabila anda memohon melalui platform kami.",
        ...
        <section id="manfaat" className="py-24 bg-surface relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 className="font-display text-4xl lg:text-5xl font-bold text-gray-900 mb-4">{title} <span className="text-primary">{highlightedTitle}</span></h2>
