...
interface ProductsProps {
    ...
    title?: string;
    description?: string;
    items?: Array<{ icon: string; title: string; desc: string; gradient: string; shadow: string }>;
}

export default function Products({ 
    onOpenModal,
    badge = "Produk Kami",
    title = "Pembiayaan untuk Setiap Keperluan",
    description = "Pilih produk yang sesuai dengan keperluan kewangan anda.",
        ...
        <section id="produk" className="py-24 bg-white relative">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <span className="inline-block px-4 py-1.5 rounded-full bg-lime/20 text-gray-900 text-sm font-semibold mb-4">{badge}</span>
